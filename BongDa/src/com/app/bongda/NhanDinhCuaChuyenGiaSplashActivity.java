...
public class NhanDinhCuaChuyenGiaSplashActivity extends TabActivity implements OnTabChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		addTab(NhanDinhChuyenGiaActivity.class, "M4", "M4", R.drawable.menu_5);
	}
	...
	private BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (index <= 3) {
				...
				startActivity(new Intent(NhanDinhCuaChuyenGiaSplashActivity.this, PhongDoCacDoiActivity.class));
			} else if (index == 6) {
				// May tinh du doan
				// chua co
				startActivity(new Intent(NhanDinhCuaChuyenGiaSplashActivity.this, MayTinhDuDoanActivity.class));
			} else if (index == 5) {
				// nhan dinh cua chuyen gia
				// crash
				startActivity(new Intent(NhanDinhCuaChuyenGiaSplashActivity.this, NhanDinhChuyenGiaActivity.class));
			} else if (index == 4) {
				// game du doan
				// chua co
				startActivity(new Intent(NhanDinhCuaChuyenGiaSplashActivity.this, GameDuDoanActivity.class));
