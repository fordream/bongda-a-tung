...
import com.acv.libs.base.MbaseAdialog;
...
public class RegisterFacebookTwitterDialog extends MbaseAdialog implements android.view.View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (user == null) {
			...
			findViewById(R.id.registerfacebooktwitter_btn1).setBackgroundResource(R.drawable.btn_register_twiiter);
		} else {
			setText(R.id.registerfacebooktwitter_edt1, user.getName());

			findViewById(R.id.registerfacebooktwitter_btn1).setBackgroundResource(R.drawable.btn_register_facebook);
		}
