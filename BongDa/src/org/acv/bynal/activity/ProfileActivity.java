...
//	public static String uploadImg = "123";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		contex = this;
//		HeaderOption headerOption = new HeaderOption(this, TYPEHEADER.NORMAL);
//
...
//		getHeaderView().setheaderOption(headerOption);
	...
	public void configMenuleft() {
		...
		addmenu(new MenuItem(getResources().getString(
				R.string.menu_profile_changepass), R.drawable.profile_menu_change_password,
				true));
		addmenu(new MenuItem(getResources().getString(
				R.string.menu_profile_unregister), R.drawable.profile_menu_unregister,
				true));
	}
