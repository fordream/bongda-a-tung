...
public class GcmBroadcastReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (getStatusPush(context) == ENABLE) {
			...
			String username_addfavorite = baseItem
					.getString("username_addfavorite");
			...
			if (pushtype == PUSHTYPE.message) {
				...
				notificationIntent.putExtra("projectIdDetail",
	...
	public static void register(final Context context) {
		...
		final String SERVER = ByUtils.BASESERVER_REGISTER_PUSH
				+ "/bynal_push/register/android";
